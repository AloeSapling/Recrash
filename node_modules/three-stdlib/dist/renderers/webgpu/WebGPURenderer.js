...
const WebGPUObjects = require("./WebGPUObjects.js");
const WebGPUAttributes = require("./WebGPUAttributes.js");
const WebGPUGeometries = require("./WebGPUGeometries.js");
const WebGPUInfo = require("./WebGPUInfo.js");
const WebGPUProperties = require("./WebGPUProperties.js");
const WebGPURenderPipelines = require("./WebGPURenderPipelines.js");
const WebGPUComputePipelines = require("./WebGPUComputePipelines.js");
const WebGPUBindings = require("./WebGPUBindings.js");
const WebGPURenderLists = require("./WebGPURenderLists.js");
const WebGPUTextures = require("./WebGPUTextures.js");
const WebGPUBackground = require("./WebGPUBackground.js");
const WebGPUNodes = require("./nodes/WebGPUNodes.js");
...
THREE.Matrix4.prototype.makePerspective = function(left, right, top, bottom, near, far) {
...
class WebGPURenderer {
  constructor(parameters = {}) {
    ...
    this._clearAlpha = 1;
    this._clearColor = new THREE.Color(0);
    this._clearDepth = 1;
    ...
    this._parameters.extensions = parameters.extensions === void 0 ? [] : parameters.extensions;
    this._parameters.limits = parameters.limits === void 0 ? {} : parameters.limits;
  }
  async init() {
    ...
    const context = parameters.context !== void 0 ? parameters.context : this.domElement.getContext("gpupresent");
    ...
    this._renderPassDescriptor = {
      ...
      depthStencilAttachment: {
        attachment: null,
        depthStoreOp: constants.GPUStoreOp.Store,
        stencilStoreOp: constants.GPUStoreOp.Store
      }
    };
  ...
  _setupIndexBuffer(index, encoder) {
    ...
    const indexFormat = index.array instanceof Uint16Array ? constants.GPUIndexFormat.Uint16 : constants.GPUIndexFormat.Uint32;
