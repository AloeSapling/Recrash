...
const Sld = () => {
    return ( 
        <div className="gra">
            <Fade top>
                <div className="w-[100%] ">
                    <h1 className="flex justify-center mb-[50px] text-[70px] font-bold text-[#3C7339] mt-[0px]">Dowiedź się więcej o odpadach</h1>
                </div>
            </Fade>
            <br />
            <Slide left>
            ...
            <div className="flex justify-end mb-[50px]">
                <div className="w-[100%] h-[20%] bg-[#7CAA29] rounded-[45px] mr-[-50px] grid grid-cols-3 grid-rows-2 gap-2 lg:w-[70%] lg:h-[40%]  justify-center items-center" >
                    <img className="row-span-2 w-[225px] h-[200px] ml-[65px] mb-[120px]" src="./clothes.png" alt="" />
                     ...
                     <p className="col-span-2 col-start-2 row-start-2 mr-[100px] text-white text-right justify-end flex items-center max-w-[600px] text-[130%] mt-[-8.5%] mb-[10px]">Ubrania nie powinno się wyrzucać. Jeżeli chcemy się pozbyć starych ubrań to najlepiej albo je oddać albo je sprzedać. Kontenery do oddawania można znaleźć w wielu miastach pod postacią PCK, Eco Textil, itd. Alternatywą tego są portale jak np. “ubrania do oddania”, które wysyłają darmowego kuriera, który odbierze ubrania. Jeżeli mamy ubrania, które już nie są do użytku, można często znaleźć kosze na tkaniny w PSZOKu. Choć powinno się wyrzucić do tych koszy, nie będzie to zbyt duży problem jak wyrzucimy do zwykłych śmieci.</p>
                </div>
            </div>
            </Slide>
            <Slide left>
